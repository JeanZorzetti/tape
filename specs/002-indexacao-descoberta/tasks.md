...
- [X] T015 [US2] Executar a verificação no painel do Bing pela importação do GSC e registrar em `docs/bing-webmaster.md` a data e o método que funcionou — **bloqueada: exige a conta do usuário no Bing Webmaster Tools**
...
- [X] T017 [US2] Submeter `https://tapepro.roilabs.com.br/sitemap-index.xml` no painel e registrar em `docs/bing-webmaster.md` o número de URLs descobertas
